...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-white shadow-lg transform hover:scale-105 transition-all duration-300">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-blue-100 text-sm font-medium">Total Artikel</p>
                    <p class="text-3xl font-bold mt-2">{{ $artikels->count() }}</p>
                </div>
        ...
        <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl p-6 text-white shadow-lg transform hover:scale-105 transition-all duration-300">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-green-100 text-sm font-medium">Published</p>
                    <p class="text-3xl font-bold mt-2">{{ $artikels->where('status', 'published')->count() }}</p>
                </div>
        ...
        <div class="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl p-6 text-white shadow-lg transform hover:scale-105 transition-all duration-300">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-orange-100 text-sm font-medium">Draft</p>
                    <p class="text-3xl font-bold mt-2">{{ $artikels->where('status', 'draft')->count() }}</p>
                </div>
        ...
        <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl p-6 text-white shadow-lg transform hover:scale-105 transition-all duration-300">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-purple-100 text-sm font-medium">Views</p>
                    <p class="text-3xl font-bold mt-2">{{ $artikels->sum('views') }}</p>
                </div>
...
<div class="relative h-48 bg-gradient-to-br from-primary-500 to-primary-600 overflow-hidden">
    ...
    @else
    <img src="{{ asset('storage/artikels/default-artikel.svg') }}" alt="Default image" class="w-full h-full object-cover">
    @endif
    ...
    <div class="absolute top-4 left-4">
        ...
        @else
        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-orange-500 text-white shadow-lg">
                ...
                <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                    ...
                    <div class="flex items-center space-x-2">
                        @if(auth()->user()->isAdmin() || auth()->user()->isGuru())
                            @if($artikel->user->role === 'siswa' && $artikel->status === 'draft')
                                <!-- Approval buttons for student articles -->
