    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    ...
                    <div class="flex items-center justify-between mt-8 pt-6 border-t border-gray-200">
                        <div class="flex items-center space-x-6 text-gray-500">
                            ...
                            <span class="flex items-center space-x-2">
                                ...
                                <span>{{ $artikel->like_count }} likes</span>
                            </span>
                            <span class="flex items-center space-x-2">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <div class="flex-1">
                            ...
                            @if(auth()->check() && (auth()->user()->isAdmin() || auth()->user()->isGuru()) && !$comment->is_approved)
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-6 border border-gray-100">
                ...
                <div class="space-y-4">
                    @php
                        $relatedArticles = App\Models\Artikel::where('id_kategori', $artikel->id_kategori)
                    ...
                    <a href="{{ route('artikel.show', $related) }}" class="block group">
                        <div class="flex items-center space-x-3 p-3 rounded-lg border border-gray-200 hover:border-primary-300 hover:bg-primary-50 transition-all duration-300">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-gray-500 mt-1">{{ $related->tanggal->format('d M') }}</p>
                            </div>
                        </div>
                    </a>
                    @endforeach
